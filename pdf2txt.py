...
from pdfminer.converter import XMLConverter, HTMLConverter, TextConverter,InvConverter
...
def main(argv):
    ...
    try:
        (opts, args) = getopt.getopt(
            argv[1:], 'dp:m:P:o:CnAVM:L:W:F:Y:O:R:St:c:s:')
    ...
    if outtype == 'text':
        ...
        device = InvConverter(rsrcmgr, outfp, codec=codec, laparams=laparams,
                               imagewriter=imagewriter)
    elif outtype == 'xml':
